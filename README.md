...
```bash
git clone [https://github.com/vipulsingh253/Airbnb Clone.git]([https://github.com/vipulsingh253/airbnb-mern-clone](https://github.com/vipulsingh253/Airbnb Clone.git)
cd Airbnb Clone
